					...
					<div class="p-3 p-lg-5 border bg-white">
						...
						<div class="form-group">
							<label for="c_create_account" class="text-black"
								...
								aria-controls="create_an_account"><input type="checkbox"
						...
						<div class="form-group">
							<label for="c_ship_different_address" class="text-black"
								data-bs-toggle="collapse" href="#ship_different_address"
								role="button" aria-expanded="false"
								aria-controls="ship_different_address"><input
								type="checkbox" value="1" id="c_ship_different_address" /> Ship
